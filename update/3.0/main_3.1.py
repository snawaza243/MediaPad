...
def get_random_dev_joke():
    try:
        ...
        jokes = [
            ...
            "Why do programmers prefer dogs? Because they always get the boolean.",
            "Why do programmers prefer gardening? Because they love to use their git.",
            "Why don't programmers like nature? It has too many bugs.",
            "Why don't programmers like nature? Because they prefer artificial intelligence.",
            "Why don't programmers like the sun? It burns their retina display.",
            "Why don't programmers like nature? Because they like to stay indoors to avoid race conditions.",
            "Why don't programmers like nature? Because it's hard to CTRL-C in the woods.",
            "Why do programmers prefer dark mode? Because light attracts syntax errors."
        ]
        joke = random.choice(jokes)
        messagebox.showinfo("MediaPad | Developers Quote of the Day (Offline)", joke)


# defined colors for button and background
start_color = "#2ecc71"
save_color = "#1E90FF"
copy_color = "#FFA500"
clear_color = "#95a5a6"
...
# Home page features button color binding
...
# Home page features button position
