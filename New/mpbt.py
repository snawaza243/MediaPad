...
t1 = Text(root, width=30, height=10, borderwidth=2, pady=5, padx=5, relief=RIDGE)
t1.place(x=10, y=100)

# t2 for output text area
t2 = Text(root, width=30, height=10, borderwidth=2, pady=5,  padx=5, relief=RIDGE)
t2.place(x=260, y=100)


# right click menu list in output text are
...
lTranslate = Label(root, text="Translate Now", font=("Century Gothic", 22, "bold"))
lTranslate.place(x=160, y=15)


bTranslate1 = Button(root, text="Translate", relief=RIDGE, borderwidth=2, font=('verdana', 10, 'bold'), cursor="hand2", command=translate)
bTranslate1.place(x=10, y=280)

ClearBtn1 = Button(root, text="Clear", relief=RIDGE, borderwidth=2,
                 font=('verdana', 10, 'bold'), cursor="hand2", command=clear)
ClearBtn1.place(x=120, y=280)

CopyBtn1 = Button(root, text="Copy ", relief=RIDGE, borderwidth=2,
                font=('verdana', 10, 'bold'), cursor="hand2", command=clear)
CopyBtn1.place(x=200, y=280)


HomeBtn1 = Button(root, text="Home", relief=RIDGE, borderwidth=2,
                font=('verdana', 10, 'bold'), cursor="hand2", command=clear)
HomeBtn1.place(x=10, y=315)
...
AboutBtn1 = Button(root, text="About", relief=RIDGE, borderwidth=2,
                 font=('verdana', 10, 'bold'), cursor="hand2")
AboutBtn1.place(x=380, y=315)
